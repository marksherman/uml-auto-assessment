...
int gameLogic(char a, char b)
{
  ...
  case rock:/*player 1 is rock*/
    if ( b == paper || b == spock ){/*player2 is paper or  spock*/
      return player2;
      break;
    }
    return player1;
  ...
  case scissors:/*player 1 is scissors*/
    if ( b == rock || b == spock ){
      return player2;
      break;
    }
  ...
  case lizard:/*player 1 is lizard*/
