...
namespace CxxTest
{
    ...
    void TestTracker::suiteInitError(const char *file, unsigned line, const char *expression)
    {
    	_l->suiteInitError(file, line, expression);
    }
    
    void** TestTracker::sigBacktrace()
    {
        return CxxTest::__cxxtest_sig_backtrace;
    }
