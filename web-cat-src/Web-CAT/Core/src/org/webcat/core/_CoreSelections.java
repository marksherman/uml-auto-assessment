    ...
    extends org.webcat.core.EOBase
{
     ...
     */
    @SuppressWarnings("unchecked")
    public static NSArray<CoreSelections> objectsWithFetchSpecification(
     ...
     */
    public static CoreSelections firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static CoreSelections uniqueObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching CoreSelections";
            try
            {
                if (qualifier != null)
                {
     ...
     * @return the first entity that was retrieved, or null if there was none
     */
    public static CoreSelections firstObjectMatchingValues(
        EOEditingContext context,
        NSArray<EOSortOrdering> sortOrderings,
        Object... keysAndValues)
    {
     ...
     *     if there is more than one matching object
     */
    public static CoreSelections uniqueObjectMatchingValues(
        EOEditingContext context,
