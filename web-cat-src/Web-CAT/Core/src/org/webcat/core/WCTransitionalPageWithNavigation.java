...
import org.webcat.core.WCTransitionalPageWithNavigation;
    ...
    extends WCTransitionalBasePage
{
     ...
     */
    public WCTransitionalPageWithNavigation( WOContext context )
    {
        super( context );
    }
    ...
    static Logger log = Logger.getLogger(WCTransitionalPageWithNavigation.class);
}
