    ...
    extends FeatureDescriptor
{
     ...
     * since clients should use the {@link BatchPlugin#descriptor()}
     * method instead.
     * @param plugin the plug-in this descriptor is for
     */
    protected BatchPluginDescriptor(BatchPlugin plugin)
    {
        this.plugin = plugin;
    ...
    {
        Object result = plugin.configDescription().valueForKey(propName);
    ...
    protected BatchPlugin plugin;

    static Logger log = Logger.getLogger(BatchPluginDescriptor.class);
}
