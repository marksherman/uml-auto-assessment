    ...
    extends org.webcat.core.EOBase
{
        ...
        EOEditingContext ec, int id)
    {
        ...
        if (id > 0)
        {
            NSArray<ReportDataSetQuery> objects =
    ...
    public static final ERXKey<org.webcat.reporter.ReportDataSet> dataSet =
        new ERXKey<org.webcat.reporter.ReportDataSet>(DATA_SET_KEY);
     ...
     */
    public org.webcat.reporter.ReportDataSet dataSet()
    {
        return (org.webcat.reporter.ReportDataSet)storedValueForKey( "dataSet" );
    }
     ...
     */
    public void setDataSet( org.webcat.reporter.ReportDataSet value )
    {
    ...
    public void setDataSetRelationship(
        org.webcat.reporter.ReportDataSet value )
    {
        if (log.isDebugEnabled())
        {
        ...
        if ( value == null )
        {
            org.webcat.reporter.ReportDataSet object = dataSet();
            if ( object != null )
     ...
     */
    public static ReportDataSetQuery firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static ReportDataSetQuery uniqueObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier) throws EOUtilities.MoreThanOneException
    {
        ...
        if (objects.size() > 1)
        {
            String msg = "fetching ReportDataSetQuery";
            try
            {
                if (qualifier != null)
                {
