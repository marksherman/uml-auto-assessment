...
def compare_substring(reference_file, student_file, substring): 
    ...
    reference_substrings_found = map(reference_search, substring)
    print reference_substrings_found
    student_substrings_found = map(student_search, substring)
    print reference_substrings_found
...
for each_file in glob.glob('*reference.out'):
    if each_file.endswith("reference.out"): 
           ...
           if ((os.path.exists( count_str + "testdata" + assignment_Number )) and (os.path.exists( count_str + "arguments" ))): 
               ...
               #os.system("echo \"" + case_temp_string + "\" | ./a.out >> " + count_str + user_Name + ".out")
               os.system("echo " + case_temp_string + " | ./a.out >> " + count_str + user_Name + ".out")
           temp = compare_substring(instructor_file, student_file, substring.substring)
